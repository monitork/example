...
class FLChartStyle extends ThemeExtension<FLChartStyle> {
  ...
  @override
  ThemeExtension<FLChartStyle> lerp(ThemeExtension<FLChartStyle>? other, double t) {
    ...
    return FLChartStyle(
      ...
      chartColor1: Color.lerp(backgroundColor, other.backgroundColor, t) ?? backgroundColor,
      chartColor2: Color.lerp(backgroundColor, other.backgroundColor, t) ?? backgroundColor,
      chartColor3: Color.lerp(backgroundColor, other.backgroundColor, t) ?? backgroundColor,
      chartBorderColor: Color.lerp(backgroundColor, other.backgroundColor, t) ?? backgroundColor,
      toolTipBgColor: Color.lerp(backgroundColor, other.backgroundColor, t) ?? backgroundColor,
      isShowingMainData: (lerpDouble(isShowingMainData.boolToInt, other.isShowingMainData.boolToInt, t) ??

...
class AppTextTheme {
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    displayMedium: displayMedium.copyWith(color: AppTheme.darkColors.defaultText),
    displaySmall: displaySmall.copyWith(color: AppTheme.darkColors.defaultText),
    headlineLarge: headlineLarge.copyWith(color: AppTheme.darkColors.defaultText),
    headlineMedium: headlineMedium.copyWith(color: AppTheme.darkColors.defaultText),
    headlineSmall: headlineSmall.copyWith(color: AppTheme.darkColors.defaultText),
  ...
  static TextTheme textTheme = TextTheme(
    displayLarge: displayLarge.copyWith(color: AppTheme.lightColors.defaultText),
    displayMedium: displayMedium.copyWith(color: AppTheme.lightColors.defaultText),
    displaySmall: displaySmall.copyWith(color: AppTheme.lightColors.defaultText),
    headlineLarge: headlineLarge.copyWith(color: AppTheme.lightColors.defaultText),
    headlineMedium: headlineMedium.copyWith(color: AppTheme.lightColors.defaultText),
    headlineSmall: headlineSmall.copyWith(color: AppTheme.lightColors.defaultText),
  ...
  static const TextStyle displayLarge = TextStyle(fontSize: 57, fontWeight: FontWeight.w700);
  static const TextStyle displayMedium = TextStyle(fontSize: 45, fontWeight: FontWeight.w700);
  static const TextStyle displaySmall = TextStyle(fontSize: 36, fontWeight: FontWeight.w700);

  static const TextStyle headlineLarge = TextStyle(fontSize: 32, fontWeight: FontWeight.w700);
  static const TextStyle headlineMedium = TextStyle(fontSize: 28, fontWeight: FontWeight.w700);
  static const TextStyle headlineSmall = TextStyle(fontSize: 24, fontWeight: FontWeight.w700);

  static const TextStyle titleLarge = TextStyle(fontSize: 22, fontWeight: FontWeight.w700);
  static const TextStyle titleMedium = TextStyle(fontSize: 18, fontWeight: FontWeight.w700);
  static const TextStyle titleSmall = TextStyle(fontSize: 14, fontWeight: FontWeight.w700);
  ...
  static const TextStyle labelLarge = TextStyle(fontSize: 14, fontWeight: FontWeight.w700);
  static const TextStyle labelMedium = TextStyle(fontSize: 12, fontWeight: FontWeight.w600);
  static const TextStyle labelSmall = TextStyle(fontSize: 8, fontWeight: FontWeight.w700, letterSpacing: 0);
}
